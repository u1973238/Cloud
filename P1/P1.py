...
try:
    # Get the image URL and threshold from command-line arguments
    ...
    # Create an instance of the regionGrow class and apply the region growing algorithm
    exemple = regionGrow('image.jpg', threshold)
    exemple.ApplyRegionGrow()

except IndexError:
    print("Please provide both the image URL and threshold value as command-line arguments.")
