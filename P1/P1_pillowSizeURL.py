...
class regionGrow():
    ...
    def ApplyRegionGrow(self, cv_display=True):
        if self.h * self.w > 500000:  # Define your threshold for large images
            print("Image is too large for region growing. Skipping...")
            return
...
#threshold = requests.args.get('threshold')

image_url = requests.get(sys.argv[1]).content
